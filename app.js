...
function updateMovieTheater() {
  ...
  if (optionID === "movieTheater1") {
    screen.style.backgroundImage = "url(./images/dunki.jpg)";
    movieTheater();
  } else if (optionID === "movieTheater2") {
    screen.style.backgroundImage = "url(./images/fighter.jpg)";
    movieTheater(5);
  } else if (optionID === "movieTheater3") {
    screen.style.backgroundImage = "url(./images/hipapa.jpg)";
    movieTheater(5);
  } else if (optionID === "movieTheater4") {
    screen.style.backgroundImage = "url(./images/tiger3.jpg)";
    movieTheater(8);
  }
}
